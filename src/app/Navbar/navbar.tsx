          ...
          <div className="bg-white shadow-sm w-full">
            <div className="container mx-auto flex justify-between items-center py-4 px-4 md:px-6">
              ...
              <div className="flex items-center space-x-4">
                <h1 className="text-black text-xl md:text-2xl xl:text-3xl font-extrabold  hover:underline">
                  SHOP.CO
                </h1>
              </div>
              ...
              >
                ...
                <div className="relative md:static w-full md:w-auto">
                  ...
                  <select
                    id="shop-dropdown"
                    className="block md:inline bg-white border border-gray-300 text-black font-bold  focus:outline-none   px-4 py-2 w-full md:w-auto cursor-pointer"
                    defaultValue="Shop"
                  >                 
                ...
                <a
                  href="#"
                  className="block md:inline  font-bold hover:scale-110 hover:underline px-4 py-2 md:px-0"
                >
                  On Sale
                </a>
                <a
