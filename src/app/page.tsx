...
<div className="md:w-1/2 space-y-6">
  ...
  <div className="mt-8 flex flex-col sm:flex-row justify-between text-center sm:text-left">
    <div className="mb-4 sm:mb-0">
      ...
      <p className="text-gray-600 font-bold ">International Brands</p>
    </div>
    <div className="mb-4 sm:mb-0">
      <h2 className="text-2xl font-bold text-black hover:scale-125 ">2,000+</h2>
      <p className="text-gray-600 font-bold ">High-Quality Products</p>
    </div>
    <div>
  ...
  <div className="container mx-auto px-6 sm:px-12 md:px-16 lg:px-20">
    <div className="flex flex-wrap justify-center items-center gap-6">
      ...
      />
                                                    ...
                                                    <h2 className=" text-4xl md:text-5xl lg:text-5xl font-extrabold text-black text-center mb-6 ">NEW ARRIVALS</h2>
                                                    ...
                                                    <button className="bg-white text-black px-16 py-2 rounded-full font-bold  border-2 border-gray-200 ">View All</button>
                                                    </div>
                                                    </div>

                                                    {/* Top Selling Section */}
                                                    <div className="container mx-auto py-10">
                                                    <h2 className=" text-4xl md:text-5xl lg:text-5xl text-black text-center mb-6 hover:scale-y-150 md:hover:scale-x-150 lg:hover:scale-x-150    font-extrabold  ">TOP SELLING</h2>
...
<div className="bg-customGray flex flex-col rounded-lg mx-4 md:mx-8 lg:mx-12 xl:mx-20">
  ...
  <div className="flex flex-col sm:flex-row mt-8 mb-8 space-x-0 sm:space-x-10 sm:space-y-0 space-y-6 sm:mt-10">
    ...
    />
                                                      ...
                                                      <div className="container mx-auto py-10">
                                                      <h2 className=" text-4xl md:text-5xl lg:text-5xl font-bold text-black text-center mb-10  ">OUR HAPPY CUSTOMERS</h2>
...
<button className="bg-white text-black px-1 py-2 w-[300px] md:w-[600px] lg:w-[600px] mb-2 ml-8 md:ml-0 lg:ml-0 rounded-full font-semibold hover:scale-x-110 border-2 border-blue-500">
